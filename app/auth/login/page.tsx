...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-lg">Sign in to continue your beauty journey</p>
          </div>
      ...
      >
        <img
          src="/confident-black-woman-with-flawless-makeup-and-ele.jpg"
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <h2 className="text-4xl font-bold mb-4">Your Beauty, Elevated</h2>
          <p className="text-xl opacity-90">Join our community of beauty enthusiasts</p>
        </div>
      </div>
    </div>
  )
